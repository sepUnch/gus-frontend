...
export default function AdminSubmissionsPage() {
  ...
  // 1. Fetch Series List untuk Dropdown
  useEffect(() => {
                    ...
                    >
                      ...
                      {allSeries.map((series) => (
                        <option key={series.id} value={series.id}>
                          {series.series_name || series.name} (Track:{" "}
                          {series.parent_track})
                        </option>
                      ))}
                    </select>
              ...
              {loadingSubmissions ? (
                    ...
                    <table className="w-full text-left text-sm min-w-[800px]">
                      ...
                      <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                        {submissions.map((sub) => {
                          ...
                          // Buat URL lengkap jika ada avatar
                            ...
                            >
                              ...
                              <td className="px-6 py-4">
                                <div className="flex items-center gap-3">
                                  ...
                                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white font-bold text-xs shadow-sm overflow-hidden flex-shrink-0">
                                    {avatarUrl ? (
                ...
                <div className="bg-slate-50 dark:bg-slate-800/50 border border-dashed border-slate-300 dark:border-slate-700 rounded-2xl p-12 text-center">
                  <p className="text-slate-500 dark:text-slate-400 text-lg">
                    Please select a series from the dropdown above to view
                    student submissions.
                  </p>
                </div>
              )}
